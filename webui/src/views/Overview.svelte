...
<style>
  ...
  .v.warn { color: #f5c469; }
  .v.bad { color: #f16a6a; }
  .logs { background: #0c0f15; border: 1px solid #232838; border-radius: 8px; padding: 0.5rem; font-family: ui-monospace, monospace; font-size: 0.82rem; max-height: 480px; overflow: auto; }
  ...
  .f { background: #1a2030; color: #a8b0c2; border-radius: 4px; padding: 0.05rem 0.35rem; font-size: 0.75rem; }
