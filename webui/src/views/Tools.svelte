...
<style>
  ...
  button { align-self: flex-start; background: #2a3b63; color: #fff; border: 1px solid #3c5189; border-radius: 6px; padding: 0.5rem 1rem; cursor: pointer; }
