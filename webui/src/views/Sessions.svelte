...
<table>
  <thead>
    <tr><th>Session ID</th><th>Updated</th><th>Length</th><th>Last Message</th></tr>
  </thead>
  <tbody>
    {#each sessions as s}
    ...
    {:else}
      <tr><td colspan="4" class="empty">No sessions yet. Send a message to the bot to start one.</td></tr>
    {/each}
  </tbody>
</table>
